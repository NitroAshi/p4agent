...
def test_factory_builds_openai_adapter(monkeypatch: pytest.MonkeyPatch) -> None:
    monkeypatch.setattr(
...
def test_factory_builds_anthropic_adapter(monkeypatch: pytest.MonkeyPatch) -> None:
    monkeypatch.setattr(
        anthropic_module,
        "AnthropicAdapter",
...
def test_factory_builds_azure_adapter(monkeypatch: pytest.MonkeyPatch) -> None:
    monkeypatch.setattr(
